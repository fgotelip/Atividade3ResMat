...
class MomentoDeInercia:
    ...
    def exibirResultados(self): ## Função para exibir os resultados
        ...
        print(f"O centroide da figura é: ({self.__Xp:.2f},{self.__Yp:.2f})")
        print(f"Momento de inércia em relação ao eixo X: {self.__Ixx:.2f} cm⁴")
        print(f"Momento de inércia em relação ao eixo Y: {self.__Iyy:.2f} cm⁴")
        print(f"Produto de inércia Ixy: {self.__Ixy:.2f} cm⁴\n")
